    ...
    <footer style={{ background: "#000", borderTop: "1px solid oklch(100% 0 0 / 0.1)" }}>
      <div className="site-shell footer-wrap">
        <div className="footer-grid">
          <div>
            <Image src="/logo.png" alt="psy.market" width={130} height={52} style={{ height: "52px", width: "auto", marginBottom: "16px" }} />
            ...
            <div className="footer-newsletter">
              ...
              />
              <button style={{ background: "var(--rust)", color: "white", border: "none", padding: "10px 16px", borderRadius: "6px", fontSize: "13px", cursor: "pointer", fontWeight: 600, fontFamily: "Manrope, var(--font-manrope)" }}>
                Join
              </button>
            </div>
          </div>
          ...
          {COLS.map((col) => (
            <div key={col.title}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "11px" }}>
                {col.links.map((link) => (
                  <Link key={link} href="/browse" style={{ fontSize: "13px", color: "oklch(52% 0.01 70)", textDecoration: "none", transition: "color 0.2s" }}>
                    {link}
                  </Link>
                ))}
              </div>
