  ...
  return (
    <div className="profile-wall">
      ...
      <style>{`
        ...
        .post-highlights-row h2 { grid-column: 1 / -1; margin: 0 0 2px; color: var(--text); font: 700 20px 'Bricolage Grotesque', var(--font-bricolage); }
        ...
        .post-highlight-overlay-panel { position: relative; width: min(680px, 100%); max-height: calc(100dvh - 40px); padding-top: 64px; box-sizing: border-box; overflow: hidden; border-radius: 12px; background: var(--white); }
        .post-highlight-overlay-content { max-height: calc(100dvh - 104px); overflow-y: auto; border-radius: inherit; }
        ...
        @media (max-width: 640px) {
          ...
          .post-highlight-overlay-content { max-height: calc(100dvh - 84px); }
