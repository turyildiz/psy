  ...
  return (
    <div style={{ background: "var(--cream)", minHeight: "100vh" }}>
      ...
      <style>{`
        ...
        @media (max-width: 640px) { .category-photo-hero { height: 130px; } .category-photo-hero-text { padding-top: 0; padding-bottom: 0; } .category-photo-hero-eyebrow { margin-bottom: 0; } .category-photo-hero-description { margin-top: 0; } .standard-category-grid { column-gap: 10px; row-gap: 14px; } }
