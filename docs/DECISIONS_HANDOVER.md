...
- Slice MP-4: **in guarded execution, packages A+B of eight live** (see [`SLICE_MP4_EXECUTION_RECORD.md`](SLICE_MP4_EXECUTION_RECORD.md)). This line is updated as packages land; package sitting details belong in the rolling execution record.
