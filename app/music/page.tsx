...
export default function MusicPage() {
  ...
  return (
    <div style={{ background: "var(--cream)", minHeight: "100vh" }}>
      ...
      {/* Hero */}
      <PageHero
        imageSrc="/music-hero.jpg"
        objectPosition="50% center"
        eyebrow="Marketplace"
        title="Music Gear"
        description="Explore synths, controllers, and everything you need to shape your sound."
      />
          ...
          <>
            {hasFeatured && (
              <div style={{ marginBottom: "56px" }}>
                ...
                <FeaturedCategoryRail className="music-featured-grid" itemCount={featuredItems.length} label="Featured Gear">
